...
class Patient(BaseModel):
    ...
    womens_health_profile = db.relationship("WomensHealthProfile", back_populates="patient", uselist=False)
...
class Appointment(BaseModel):
    ...
    __table_args__ = (
        ...
        db.CheckConstraint("scheduled_end IS NULL OR scheduled_end > scheduled_start", name="ck_appointment_time_order"),
    )
